...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  lun. 03 fév. 2020 à 08:18
...
--
-- Structure de la table `membresasc`
--

DROP TABLE IF EXISTS `membresasc`;
CREATE TABLE IF NOT EXISTS `membresasc` (
...
--
-- Déchargement des données de la table `membresasc`
--

INSERT INTO `membresasc` (`id`, `nom`, `prenom`) VALUES
(1, 'benchikh', 'messaouda'),
(2, 'sor', 'joan');
...
INSERT INTO `person` (`COL 1`, `COL 2`, `COL 3`, `COL 4`, `COL 5`, `COL 6`, `COL 7`, `COL 8`, `COL 9`, `COL 10`, `COL 11`) VALUES
